...
var NumPicMatchModel = function(initial) {
	...
	this.observables = { min : this.__coco_min, max : this.__coco_max, rand : this.__coco_rand, 'char' : this.__coco_char};
};
...
NumPicMatchModel.prototype = {
	...
	,__cocoupdate: function(delta) {
		if(delta.rand != null) {
			this.__coco_rand.set(delta.rand);
		}
		if(delta["char"] != null) {
			this.__coco_char.set(delta["char"]);
		}
	}
...
var coconut_ui_tools_PropView = function() { };
coconut_ui_tools_PropView.__name__ = true;
var coconut_ui_View0 = function(data,render) {
	coconut_ui_BaseView.call(this,data,function(data1) {
		var tmp = tink_state__$Observable_Observable_$Impl_$.get_value(data1);
		return render(tmp);
	});
};
coconut_ui_View0.__name__ = true;
coconut_ui_View0.__interfaces__ = [coconut_ui_tools_PropView];
coconut_ui_View0.__super__ = coconut_ui_BaseView;
coconut_ui_View0.prototype = $extend(coconut_ui_BaseView.prototype,{
	__class__: coconut_ui_View0
});
var NumPicMatchView = function(data) {
	coconut_ui_View0.call(this,data,$bind(this,this.render));
};
NumPicMatchView.__name__ = true;
NumPicMatchView.__super__ = coconut_ui_View0;
NumPicMatchView.prototype = $extend(coconut_ui_View0.prototype,{
	render: function(__data__) {
		...
		var children = ["Min: ",vdom_VDom.h("input",{ id : "min", oninput : function(event) {
			var attr;
			var a = Std.parseInt(event.target.value);
			if(_$UInt_UInt_$Impl_$.gte(model.get_max(),a)) {
				attr = Std.parseInt(event.target.value);
			} else {
				attr = model.get_max();
			}
			model.set_min(attr);
		}, value : Std.string(_$UInt_UInt_$Impl_$.toFloat(model.get_min())), style : "width: 50px;"}),"Max: ",vdom_VDom.h("input",{ id : "max", oninput : function(event1) {
			var attr1 = _$UInt_UInt_$Impl_$.gte(Std.parseInt(event1.target.value),model.get_min()) ? Std.parseInt(event1.target.value) : model.get_min();
			model.set_max(attr1);
		}, value : Std.string(_$UInt_UInt_$Impl_$.toFloat(model.get_max())), style : "width: 50px;"}),vdom_VDom.h("button",{ onclick : function(event2) {
			model.random();
		}},["Randomize"])];
		var children1 = vdom_VDom.h("div",{ className : "no-print"},children);
		var attr2 = { style : "width:" + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1)) + "vw; height: " + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1)) + "vw; border:1px solid black; font-family:webdings; font-size:" + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1) / _$UInt_UInt_$Impl_$.toFloat(model.get_rand() + 1)) + "vw; text-align:center;"};
		var _g2 = [];
		var _g21 = 0;
		...
		var children2 = vdom_VDom.h("div",attr2,[vdom__$VNode_VNode_$Impl_$.flatten(_g2)]);
		var attr3 = { style : "text-align:center; width:100%; font-size:" + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1) / 2) + "vw"};
		var i2 = model.get_rand();
		var children3 = [children2,vdom_VDom.h("div",attr3,[i2 == null ? "null" : "" + i2])];
		var children4 = vdom_VDom.h("div",{ style : "float:left; margin: 4px;"},children3);
		var _g12 = [];
		var _g22 = 0;
		while(_g22 < arr.length) {
			var i3 = arr[_g22];
			++_g22;
			var children5 = [vdom_VDom.h("div",{ style : "width:" + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1)) + "vw; height: " + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1)) + "vw; border:1px solid black;"},null),vdom_VDom.h("div",{ style : "text-align:center; width:100%; font-size:" + Math.floor(_$UInt_UInt_$Impl_$.toFloat(100) / _$UInt_UInt_$Impl_$.toFloat(length + 1) / 2) + "vw"},[i3 == null ? "null" : "" + i3])];
			_g12.push(vdom__$VNode_VNode_$Impl_$.flatten([vdom_VDom.h("div",{ style : "float:left; margin: 4px;"},children5)]));
		}
		var children6 = [children4,vdom__$VNode_VNode_$Impl_$.flatten(_g12)];
		var children7 = [children1,vdom_VDom.h("div",{ style : "height:100%"},children6),vdom_VDom.h("div",{ style : "clear:both"},null)];
		return vdom_VDom.h("div",{ style : "height:100%"},children7);
	}
...
var tink_state__$Observable_AutoObservable = function(comp) {
	...
	tink_state__$Observable_SimpleObservable.call(this,function() {
		...
		this1 = this2;
		return this1;
	},{ fileName : "Observable.hx", lineNumber : 313, className : "tink.state._Observable.AutoObservable", methodName : "new"});
};
